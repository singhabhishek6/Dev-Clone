...
export const Setting = () => {
    ...
    const setDisplayToNone = () => {
        ...
        else if (currentSelectedTab === "customize") setCustomizationDisplay("none");
                ...
                <div className={styles.box}>
                    ...
                    <div className={styles.settingBody}>
                        <div className={styles.leftSideBar}>
                            <div className={styles.leftSideContent} style={{ background: profileBG }} onClick={() => {
                                setDisplayToNone();
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img"><title id="ac8rzijw9o8mvhps99vvzuftvig54kzr">Profile</title>
                            ...
                            <div className={styles.leftSideContent} style={{ background: customizationBG }} onClick={() => {
                                setDisplayToNone();
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" ariaLabelledby="a9ai80uggz3lyx9lwjemg019dmdtkrns" className="crayons-icon crayons-icon--default"><title id="a9ai80uggz3lyx9lwjemg019dmdtkrns">Customization</title>
                            ...
                            <div className={styles.leftSideContent} style={{ background: NotificationsBG }} onClick={() => {
                                setDisplayToNone()
                            ...
                            <div className={styles.leftSideContent} style={{ background: accountBG }} onClick={() => {
                                setDisplayToNone();
                            ...
                            <div className={styles.leftSideContent} style={{ background: billingBG }} onClick={() => {
                                setDisplayToNone()
                            ...
                            <div className={styles.leftSideContent} style={{ background: extensionBG }} onClick={() => {
                                setDisplayToNone();
