    ...
    <>
      ...
      <section className={styles.Signup__section}>
        <div className={styles.signup__page}>
          <div className={styles.signup__content}>
            ...
            <div className={styles.signup__btn}>
              <button
                className={`${styles.button__black} ${styles.btn__styles}`}
              >
                {" "}
                <i className={`${styles.icon__font} uit uit-google`}></i> Sign
                up with Google
              </button>
              <button
                className={`${styles.button__gray} ${styles.btn__styles}`}
              >
                {" "}
                <i
                  className={` ${styles.icon__font} uit uit-github-alt`}
                ></i>{" "}
                Sign up with GitHub
              </button>
              <button
                className={`${styles.button__skyblue} ${styles.btn__styles}`}
              >
                <i className={`${styles.icon__font} uit uit-twitter-alt`}></i>{" "}
            ...
            <div
              className={`${styles.flex__design} ${styles.input__div} ${
                clickResult ? styles.form__block : styles.form__visible
              }`}
            >
              <form
                className={`${styles.flex__design} ${styles.input__div}`}
                onSubmit={handleForemData}
              >
                ...
                <div className={styles.input__parent}>
                  <button
                    className={`${styles.btn__styles} ${styles.button__blue}`}
                  >
                    Continue
                  </button>
                </div>
        ...
        <div className={styles.extra__content}>
          <p className={styles.flex__design}>
            Open Source &nbsp;
            <svg
